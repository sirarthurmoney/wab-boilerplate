...
// npx hardhat deployBridges --original-networks "goerli,bsc-testnet,mumbai" --wrapped-network "chainX-testnet"
// npx hardhat deployBridges --original-networks "ethereum,bsc,polygon" --wrapped-network "chainX"
...
task("setTrustedRemote", "calls setTrustedRemoteAddress in OriginalTokenBridge on multiple networks and in WrappedTokenBridge on a wrapped token chain", require("./setTrustedRemote"))
	.addParam("originalNetworks", "comma separated list of networks where OriginalTokenBridge contract is deployed")
	.addParam("wrappedNetwork", "name of the network where WrappedTokenBridge is deployed")
// npx hardhat setTrustedRemote --original-networks "goerli,bsc-testnet,mumbai" --wrapped-network "chainX-testnet"
...
// npx hardhat registerToken --original-network "goerli" --original-token "0xa684B88A25c4AE95368d7595c9241cE364ed56Db" --wrapped-network "chainX-testnet" --wrapped-token "0x631774c0B3FDB9502b3093a22aD91FA83fEc493e"
// npx hardhat registerToken --original-network "bsc-testnet" --original-token "0x33BbFdBA6edFA6E7ac7cA5cbf8100867e0c570CF" --wrapped-network "chainX-testnet" --wrapped-token "0x631774c0B3FDB9502b3093a22aD91FA83fEc493e"
// npx hardhat registerToken --original-network "mumbai" --original-token "0x7612aE2a34E5A363E137De748801FB4c86499152" --wrapped-network "chainX-testnet" --wrapped-token "0x631774c0B3FDB9502b3093a22aD91FA83fEc493e"
...
task("registerTokens", "calls registerToken in OriginalTokenBridge and WrappedTokenBridge", require("./registerTokens"))
 ...
 // npx hardhat registerTokens --original-networks "goerli,bsc-testnet,mumbai" --wrapped-network "chainX-testnet" --tokens "WETH,USDC"
...
task("burnAndUnlock", "bridges wrapped token to original network", require("./burnAndUnlock"))
	...
	.addParam("token", "token address")
	.addParam("decimals", "token decimals")
// npx hardhat burnAndUnlock --amount "1" --original-network "bsc" --token "0xa4151B2B3e269645181dCcF2D426cE75fcbDeca9" --decimals 6 --network "chainX"
...
task("burnAndUnlockETH", "bridges wrapped token to original network", require("./burnAndUnlockETH"))
	.addParam("originalNetwork", "name of the network where OriginalTokenBridge is deployed")
	.addParam("amount", "amount to bridge")
// npx hardhat burnAndUnlockETH --amount "0.001" --original-network "goerli" --network "chainX-testnet"

task("transferOwnership", "transfers bridges ownership", require("./transferOwnership"))
	.addParam("originalNetworks", "comma separated list of networks where original tokens are deployed")
	.addParam("wrappedNetwork", "name of the network where wrapped tokens are deployed")
	.addParam("newOwner", "new owner")
// npx hardhat transferOwnership --new-owner "0x1b2B4F723e1579db0981d826017E3eaeb77Bb493" --original-networks "goerli,bsc-testnet,mumbai" --wrapped-network "chainX-testnet"
